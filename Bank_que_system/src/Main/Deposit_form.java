 ...
 * @author reyes
 */
public class Deposit_form extends javax.swing.JPanel {
    public static String transaction = "Deposit";
    public static String counter = "3", newQueue;
    public int quenum = 0;
    private Frame frame;
    public Deposit_form(Frame frame) {
        initComponents();
        this.frame = frame;
        Clock();
        limits();
