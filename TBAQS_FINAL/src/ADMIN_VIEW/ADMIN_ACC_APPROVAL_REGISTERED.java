 ...
 * @author reyes
 */
public class ADMIN_ACC_APPROVAL_REGISTERED extends javax.swing.JPanel {

    private CLIENT_VIEW.Frame frame;
    public ADMIN_ACC_APPROVAL_REGISTERED(CLIENT_VIEW.Frame frame) {
        initComponents();
        update();
        this.frame = frame;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/ADMIN_AA_REGISTERED_ACCOUNTS.gif"))); // NOI18N
        add(jLabel1);
