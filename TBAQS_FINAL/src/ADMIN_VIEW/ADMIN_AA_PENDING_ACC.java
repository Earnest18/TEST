 ...
 * @author reyes
 */
public class ADMIN_AA_PENDING_ACC extends javax.swing.JPanel {

    private CLIENT_VIEW.Frame frame;
    public ADMIN_AA_PENDING_ACC(CLIENT_VIEW.Frame frame) {
        initComponents();
    ...
    private void initComponents() {
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/ADMIN_AA_PENDING_ACCOUNTS.gif"))); // NOI18N
        add(background);
