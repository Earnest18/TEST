 ...
 * @author reyes
 */
public class EMPLOYEE_DASH extends javax.swing.JPanel {

    private CLIENT_VIEW.Frame frame;
    public EMPLOYEE_DASH(CLIENT_VIEW.Frame frame) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/EMPLOYEE_DASHBOARD.gif"))); // NOI18N
        add(jLabel1);
    ...
    private void ABTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ABTActionPerformed
       // frame.setContentPane(new EMPLOYEE_ABTUS(frame));
        frame.revalidate();
    ...
    private void FAQSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FAQSActionPerformed
       // frame.setContentPane(new EMPLOYEE_FAQS(frame));
        frame.revalidate();
