...
public class TRANSACTIONS extends javax.swing.JPanel {
    ...
    try {
        ...
        insertPstmt.setInt(2, 0);                // Dummy Age since you don’t verify
        insertPstmt.setString(3, "INQUIRE");     // Dummy MobileNum since you don’t verify
        ...
        QUE_NUM_CONSTRUCTOR.data = info;  // <-- Make sure `data` is static or accessible
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (e.getKeyCode() == KeyEvent.VK_D) {
                    ...
                    if (shiftPressed && aPressed && dPressed) {
                        ...
                        frame.setContentPane(new ADMIN_VIEW.ADMIN_LOGIN(frame));
                ...
                if (e.getKeyCode() == KeyEvent.VK_M) {
                    ...
                    if (shiftPressed && ePressed && mPressed) {
                        ...
                        frame.setContentPane(new EMPLOYEE_VIEW.EMPLOYEE_LOGIN(frame));
                        frame.revalidate();
                        resetKeys();
                    }
                }
    ...
    private void initComponents() {
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/FINAL BANK QUEUE_1.gif"))); // NOI18N
        add(background);
    ...
    private void CREATE_ACCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CREATE_ACCActionPerformed
        frame.setContentPane(new Create_Account(frame));
        frame.revalidate();
    ...
    private void WITHDRAWActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_WITHDRAWActionPerformed
        ...
        QUE_NUM_CONSTRUCTOR qc = new QUE_NUM_CONSTRUCTOR(data);
        
        frame.setContentPane(new VERFICATION(frame));
        frame.revalidate();
    ...
    private void INQUIREActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_INQUIREActionPerformed
        ...
        generateQueueNumber("INQUIRE", "INQUIRE");
