 ...
 * @author reyes
 */
public class ADMIN_ACC_APPROVAL_PENDING extends javax.swing.JPanel {

    private CLIENT_VIEW.Frame frame;
    public ADMIN_ACC_APPROVAL_PENDING(CLIENT_VIEW.Frame frame) {
        initComponents();
        update();
        this.frame = frame;
    }
    ...
    try {
        ...
        try (java.sql.Connection con = DriverManager.getConnection(
            ...
            String sql = "SELECT Username, Age, Birthday, MobileNum FROM pending_users";
    ...
    private void initComponents() {
        ...
        REGISTER.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/BUTTONS/fillers.png"))); // NOI18N
        REGISTER.setBorderPainted(false);
        REGISTER.setContentAreaFilled(false);
        REGISTER.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/BUTTONS/clickc.png"))); // NOI18N
        REGISTER.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/BUTTONS/clickc.png"))); // NOI18N
        ...
        add(REGISTER);
        REGISTER.setBounds(0, 365, 352, 90);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/ADMIN_AA_PENDING_ACCOUNTS.gif"))); // NOI18N
        add(jLabel1);
    ...
    private void REGISTERActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_REGISTERActionPerformed
        frame.setContentPane(new ADMIN_ACC_APPROVAL_REGISTERED(frame));
        frame.revalidate();
