 ...
 * @author reyes
 */
public class EMPLOYEE_HISTORY_CANCELLED extends javax.swing.JPanel {

    private CLIENT_VIEW.Frame frame;
    public EMPLOYEE_HISTORY_CANCELLED(CLIENT_VIEW.Frame frame) {
        initComponents();
        update();
        this.frame = frame;
    }
...
public void TABLE(JTable cancelled) {
    ...
    private void initComponents() {
        ...
        HISTORY_COMPLETED.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/BUTTONS/fillers.png"))); // NOI18N
        HISTORY_COMPLETED.setBorderPainted(false);
        HISTORY_COMPLETED.setContentAreaFilled(false);
        HISTORY_COMPLETED.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/BUTTONS/clickc.png"))); // NOI18N
        HISTORY_COMPLETED.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/BUTTONS/clickc.png"))); // NOI18N
        ...
        HISTORY_COMPLETED.setBounds(0, 275, 352, 90);
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/EMPLOYEE_HISTORY_CANCELLED.gif"))); // NOI18N
        add(background);
    ...
    private void HISTORY_COMPLETEDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HISTORY_COMPLETEDActionPerformed
       frame.setContentPane(new EMPLOYEE_HISTORY_COMPLETED(frame));
       frame.revalidate();
