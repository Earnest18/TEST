 ...
 * @author reyes
 */
public class ADMIN_QUE_MANAGEMENT extends javax.swing.JPanel {
    public int hoveredRow = -1;;
    private CLIENT_VIEW.Frame frame;
    public ADMIN_QUE_MANAGEMENT(CLIENT_VIEW.Frame frame) {
        initComponents();
        update();
        tablehovered();
        this.frame = frame;
...
ONHOLD.setDefaultRenderer(Object.class, new javax.swing.table.DefaultTableCellRenderer() {
    ...
    private void initComponents() {
        ...
        MONITORING1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/BUTTONS/fillers.png"))); // NOI18N
        MONITORING1.setBorderPainted(false);
        MONITORING1.setContentAreaFilled(false);
        MONITORING1.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/BUTTONS/clickc.png"))); // NOI18N
        MONITORING1.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/BUTTONS/clickc.png"))); // NOI18N
        ...
        add(MONITORING1);
        MONITORING1.setBounds(0, 365, 352, 90);
        ...
        N1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/BUTTONS/NU.png"))); // NOI18N
        N1.setBorderPainted(false);
        N1.setContentAreaFilled(false);
        N1.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/BUTTONS/NC.png"))); // NOI18N
        ...
        N2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/BUTTONS/NU.png"))); // NOI18N
        N2.setBorderPainted(false);
        N2.setContentAreaFilled(false);
        N2.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/BUTTONS/NC.png"))); // NOI18N
        ...
        N3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/BUTTONS/NU.png"))); // NOI18N
        N3.setBorderPainted(false);
        N3.setContentAreaFilled(false);
        N3.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/BUTTONS/NC.png"))); // NOI18N
        ...
        N4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/BUTTONS/NU.png"))); // NOI18N
        N4.setBorderPainted(false);
        N4.setContentAreaFilled(false);
        N4.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/BUTTONS/NC.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG'S/grr.gif"))); // NOI18N
        jLabel1.setText("]");
        add(jLabel1);
    ...
    private void MONITORING1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MONITORING1ActionPerformed
        frame.setContentPane(new ADMIN_QUE_MONITORING(frame));
        frame.revalidate();
